...
--
--  This file is based on BackgroundWidget.lua by Yssaril which is part of AceGUISharedMediaWidgets-1.0.
--
...
------------------------------------------------------------------------------
-- Description:
--   Widget for selecting spell icons
------------------------------------------------------------------------------
-- Since this addon is dependent on clcInfo and clcInfo already has the required libraries included, I have opted to leave those libraries out of the embeds for this addon.

local AceGUI = LibStub("AceGUI-3.0")
local AGSMW = LibStub("AceGUISharedMediaWidgets-1.0")

do
	local widgetType = "CLCM_SpellIcon"
	...
	local function ContentOnEnter(this, button)
		-- yeah so this doesn't really do anything atm
	end
	...
	local function SetText(self, text) -- Set the text displayed in the box.
		...
		local background = self.list[text] and self.list[text].texture or ""
